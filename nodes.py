...
class DeepInfraImageGenerator:
    ...
    FUNCTION = "deepInfraimageGenerator"
    CATEGORY = "YCYY/fluxapi"
    DESCRIPTION = "Generates an image using the DeepInfra API"
    def deepInfraimageGenerator(self,prompt,model,seed,width,height,prompt_upsampling,safety_tolerance):
        try:
...
NODE_CLASS_MAPPINGS = {
    "YCYY_DeepInfra_ImageGenerator": DeepInfraImageGenerator
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "YCYY_DeepInfra_ImageGenerator": "YCYY DeepInfra ImageGenerator"
}   